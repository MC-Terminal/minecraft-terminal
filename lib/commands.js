...
commands.alwaysDig = (x, y, z) => {
	...
	bot.on(`blockUpdate:(${x}, ${y}, ${z})`, commands.alwaysDig.onBlockUpdate);

	success('Started');
};
commands.alwaysDig.onBlockUpdate = (oldBlock, newBlock) => {
